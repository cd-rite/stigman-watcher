 ...
 */
async function apiRequest({method = 'GET', endpoint, json, authorize = true, fullResponse = false, responseType = 'json'}) {
...
export function getCollectionMetrics(collectionId, format) {
  ...
  return apiRequest({
    method: 'GET',
    endpoint: `/collections/${collectionId}/metrics/detail?format=${format}`,
